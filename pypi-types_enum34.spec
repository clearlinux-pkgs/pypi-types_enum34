...
Source0  : https://files.pythonhosted.org/packages/3e/25/3a76fb3e7453902207e7d4b72f61eeea109213a9d32c9515e68b6b6d5688/types-enum34-1.1.7.tar.gz
...
%prep
%setup -q -n types-enum34-1.1.7
cd %{_builddir}/types-enum34-1.1.7
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1642608221
